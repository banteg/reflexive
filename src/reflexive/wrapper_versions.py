...
def default_json_path(source_id: str) -> Path:
    return repo_root() / "docs" / "generated" / source_id / "wrapper_versions.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Markdown output path. Defaults to docs/generated/<source_id>/wrapper_versions.md when the source can be inferred.",
    )
    parser.add_argument(
        "--json-out",
        type=Path,
        default=None,
        help="JSON output path. Defaults to docs/generated/<source_id>/wrapper_versions.json when the source can be inferred.",
    )
