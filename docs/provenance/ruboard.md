...
- The recovered `listkg` binary and [src/reflexive/keygen.py](../../src/reflexive/keygen.py) fit the documented post-2007 per-game RSA model, not the earlier universal-keygen model.
