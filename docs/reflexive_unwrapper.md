...
- Output shape: Materialize wrapper-free trees under artifacts/unwrapped by removing ReflexiveArcade/ content, wrapper launcher copies, encrypted child blobs, RAW_002/RAW_003 wrapper sidecars, and wrapper-only top-level assets such as Background.jpg, button_*.jpg, and wraperr.log.
...
| `Reflexive Arcade C/Cash Cow/bin` | `other` | `top_level_exe` | `artifacts/extracted/Reflexive Arcade C/Cash Cow/bin/launcher.exe` |
